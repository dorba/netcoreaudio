...
{
    /// <summary>
    /// Tests all methods of the IAudioOutputSelector interface.
    /// </summary>
    [TestClass]
    public class IAudioOutputSelectorTest : TestClass<IAudioOutputSelector>
    {
        /// <summary>
        /// Tests that the selected part ID of the output selector can be received, for each applicable part in the system.
        /// </summary>
        [TestMethod]
        public void IAudioOutputSelector_GetSelection()
        {
        ...
        /// <summary>
        /// Tests that the selected part ID of the output selector can be set, for each applicable part in the system.
        /// </summary>
        [TestMethod]
        public void IAudioOutputSelector_SetSelection()
        {
            ExecutePartActivationTest(activation =>
            {
